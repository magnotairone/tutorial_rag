...
O código fonte completo usado neste tutorial está disponível no diretório `codigos/` [neste repositório](https://github.com/magnotairone/tutorial_rag/tree/main/codigos) no GitHub. 
